...
class SubcategoriaViewTests(TestCase):
    def setUp(self):
        ...
        self.subcategoria = Subcategoria.objects.create(
            nombre="Subcategoria 1", categoria=self.categoria
        )
    ...
    def test_crear_subcategoria(self):
        ...
        response = self.client.post(
            reverse("crear_subcategorias"),
            {"nombre": "Subcategoria 1", "categoria": self.categoria.pk},
        )

        self.assertEqual(
            Subcategoria.objects.filter(nombre="Subcategoria 1").count(), 1
        )
    ...
    def test_crear_subcategoria_post_invalid(self):
        ...
        response_invalid = self.client.post(
            reverse("crear_subcategorias"),
            {"nombre": "", "categoria": self.categoria.pk},  # Nombre vacío
    ...
    def test_eliminar_subcategoria_post(self):
        ...
        response = self.client.post(
            reverse("eliminar_subcategoria", args=[self.subcategoria.pk])
        )
